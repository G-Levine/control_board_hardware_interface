...
namespace control_board_hardware_interface
{
    ...
    std::vector<hardware_interface::StateInterface> ControlBoardHardwareInterface::export_state_interfaces()
    {
    ...
    std::vector<hardware_interface::CommandInterface> ControlBoardHardwareInterface::export_command_interfaces()
    {
        ...
        const rclcpp::Time & /*time*/, const rclcpp::Duration &period)
    {
        ...
        // RCLCPP_INFO(rclcpp::get_logger("ControlBoardHardwareInterface"), "Joint 0: %f", spi_data_->q_abad[1]);
        ...
        imu_quat.setValue(imu_output_.quat.x(), imu_output_.quat.y(), imu_output_.quat.z(), imu_output_.quat.w());
        ...
        // Print the IMU
        // RCLCPP_INFO(rclcpp::get_logger("ControlBoardHardwareInterface"), "IMU: %f, %f, %f, %f, %f, %f, %f, %f, %f, %f",
...
PLUGINLIB_EXPORT_CLASS(
    control_board_hardware_interface::ControlBoardHardwareInterface, hardware_interface::SystemInterface)
